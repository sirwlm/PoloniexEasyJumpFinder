...
myAccountKey = os.environ.get("POLONIEX_ACCOUNT_KEY", None)  #Substitute your account key
myAccountSecret = os.environ.get("POLONIEX_ACCOUNT_SECRET", None) #Substitute your account secret
